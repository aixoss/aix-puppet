...
## Description
 ...
 Operations desired by the user are written into a manifest file, using Puppet
  ...
  declarative clauses have been implemented for AixAutomation Puppet module, to 
  trigger necessary operations to automatically perform AIX updates and 
  patch management. These new declarative clauses are based on three custom types
  described below in detail: 'download', 'patchmngt', and 'fix'.<br>
 ...
 - List of necessary eFix is computed (for each LPAR) and retrieved using 
  ...
  without performing any operation on the LPARs themselves, therefore without 
...
### What AixAutomation module affects 
 This module requires available disk space to store updates downloaded from 
  ...
  and then set into ./manifests/init.pp ('root' property of 'download' clause 
  for AIX updates, and 'root' property of 'fix' clause for eFix).  
...
### Installation directory 
  ...
  The AixAutomation module generates all outputs under this directory 
   ...
   (ou have one 'root' property for 'download' and one 'root' directory for 
   'fix').  
...
### Custom types and providers
 ...
 These tree custom type constitute the vocabulary which can be used as part of 
  Puppet DSL into manifest file. <br> 
 ...
 "root" property is used as download directory: it should be an ad-hoc file 
 ...
 It is possible to perform only the suma 'preview' (and therefore not the suma 
  'download') by setting the 'to_step' property of the download custom type to 
  'preview'. By default, this 'to_step' property is set to 'download', meaning 
  that the suma download is performed. 
 One new property 'force' enables to force downloads of everything from scratch, 
  even if the results of downloads are available. Set this 'force' property to 
 ...
 ##### Properties
 - <b>provider</b>: this property is not mandatory, if mentioned it needs to 
  contain name of the provider implementing the 'download' custom type, 
  therefore the value needs to be: <b>suma</b>.  
 - <b>ensure</b>: to control flow of execution, this property can take two 
  ...
  If set the <b>present</b>, suma command will be attempted so that what is set 
   into properties is performed: suma downloads according to properties 
   values. <br> 
 ...
 - <b>type</b>: type of suma downloads. Three possible values: <b>SP</b> to 
  ...
  for internal use.   
 - <b>from</b>: property used to launch suma-download command, indicating the 
 ...
 - <b>to</b>: property used to launch suma-download command, indicating the 
 ...
 - <b>lpp_source</b>: name of the NIM lpp_source resource built containing 
  ...
  by concatenating 'type', 'from', and 'to' properties. The name of this 
 ...
 - <b>to_step</b>: to control flow of execution up to a given step. Two 
  ...
  by setting this property to <b>preview</b>, in that case download is not done.
 - <b>force</b>: to force suma download again. Two possible values for this 
  property: 
   ...
   If set to <b>yes</b>, this property can force a new suma download (even if 
 ...
 ##### Explanations
  ...
  preliminary step, by using into 'lpp_source' property the lpp_source which 
  ...
  You can perform operation synchronously or asynchronously depending on 'sync' 
   property.<br> 
  You can perform preview only depending on 'preview' property.<br>*
  Several modes of updates exist: apply, commit, reject. See several 
   documented examples in ./examples/init.pp. 
 ##### Properties
   - <b>provider</b>: this property is not mandatory, if mentioned it needs 
   ...
   so that what is set into properties is performed.<br>
  ...
  - <b>action</b>: action to be performed. This property can take several 
  ...
  - <b>mode</b>: mode of update. By default update is performed in apply mode, 
   ...
   It is possible to commit the updates, by setting this <b>mode</b> property 
  ...
  - <b>sync</b>: if action needs to be done synchronously or asynchronously. 
    Two possible values for this property: <b>yes</b> and <b>no</b>. 
 ...
 Executions can be stopped after any step, and this is controlled through the 
  'to_step' property into ./manifests/init.pp.<br>
 ...
 All yaml files can be reused between two executions, to spare time if ever the 
  ...
  property which needs then to be set to 'no'. By default it is set to 'yes', 
 ...
 ##### Properties
   ...
   <b>to_step</b> property. <br> By default, <b>installResource</b> is assumed, 
   ...
   exploiting any persisted information. Two possible values for this property: 
   ...
   step by step (refer to <b>to_step</b> property), you can keep previous 
   results by setting this property to <b>no</b>. 
...
## Release Notes 
 ### Last changes documented
  #### 0.6.5
   - Many fixes
    ...
    -- Better messages on validating 'download' properties
    ...
    -- Fix custom type 'clean' property is changed to 'force' property
 ...
 #### 0.5.5
   - Many fixes
    ...
    -- Add 'to_step' property to "download" custom type, to control execution 
